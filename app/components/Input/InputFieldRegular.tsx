    ...
    return (
        <div className="mb-4">
            ...
            <input className="bg-paper-600 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                value={currentValue || ""} 
                onChange={(e) => clickHandler ? clickHandler(e.target.value) : ""} 
                type="input" 
                name={label} 
                id={label+id}/>
        </div>
...
export const InputFieldEmail = (props: IInputFieldRegularProps) => {
    // TODO this are only used serverside. Make them more generic
...
export const InputFieldPassword = (props: IInputFieldRegularProps) => {
    // TODO this are only used serverside. Make them more generic
    const { label, id } = props 
